...
public class AccessoryConnector extends Service implements Runnable {
	...
	public void closeAccessory() {
		...
		try {
			if (mFileDescriptor != null) {
				...
				Log.v(TAG,"Accessory closed");
			}
		} catch (IOException e) {
			Log.v(TAG,"IO Exception in closing accessory");
		} finally {
	...
	public class LocalBinder extends Binder {
		public AccessoryConnector getService() {
	...
	public void sendCommand(final int command, final int value) {
		...
		Log.v(TAG,"sendCommand " + command + " " + value);
